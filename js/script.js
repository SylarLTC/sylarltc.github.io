...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setInterval(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_5__["openModal"])('.modal', modalTimerId), 50000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2021-06-01');
...
function forms(formSelector, modalTimerId) {
  ...
  const message = {
    ...
    success: 'Thank you! We will be contact with you soon',
